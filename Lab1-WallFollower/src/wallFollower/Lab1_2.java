...
public class Lab1_2 {
	...
	private static final int motorLow = 120; // Speed of slower rotating wheel
												// (deg/sec)
	...
	public static void main(String[] args) {
		...
		BangBangController bangbang = new BangBangController(leftMotor, rightMotor, bandCenter, bandWidth, motorLow,
				motorHigh);
